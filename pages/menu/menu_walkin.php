      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview menu-open">
          ...
          <ul class="treeview-menu menu-open" style="display: block;">
            <li><a href="checkin.php"><i class="fa fa-circle-o"></i> Check In</a></li>
            <li class="active"><a href="walkin.php"><i class="fa fa-circle-o"></i> Walkin</a></li>
        ...
        <li class=""> 
          <a href="config.php">
                <i class="fa fa-gear" aria-hidden="true"></i> <span>Configuration</span>
          </a>
        </li>
